...
public class ProdutoService {
	...
	public Produto addProduto(@FormDataParam("image") InputStream uploadedInputStream,
		@FormDataParam("nome") String nome, @FormDataParam("preco") Double preco, @FormDataParam("descricao") String descricao) {

		return ProdutoDAO.addProduto(nome, preco, descricao, uploadedInputStream);
	}
